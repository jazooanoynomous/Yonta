...
export const orderData = [
  {
    ...
    price: "3,099",
    status: "Processing",
    currentStep: 1, // Simulating the current progress (1-5)
  },
  {
    orderID: "#Order-1145",
    itemImage: "/images/1(1).png",
  ...
  },
  {
    ...
    price: "5,499",
    status: "Processing",
    currentStep: 4, // Simulating the current progress (1-5)
  ...
  },
  {
    ...
    price: "7,999",
    status: "Delivered",
    currentStep: 3, // Simulating the current progress (1-5)
  ...
  },
  {
    ...
    price: "8,499",
    status: "Shipping",
    currentStep: 5, // Simulating the current progress (1-5)
