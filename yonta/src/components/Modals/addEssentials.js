...
const EssentialsModal = ({ isOpen, onClose, onAddMealType }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black  bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg w-[470px] h-[292px] shadow-lg p-6 relative">
        <div className="flex gap-2">
          ...
          <div className="flex flex-col flex-grow mt-0 w-[251px] h-[80px] gap-2">
            ...
            <input
              ...
              value={whenToConsume}
              onChange={(e) => setWhenToConsume(e.target.value)}
              className="w-[251px] h-[80px] p-2 mb-4 border rounded-lg bg-gray-100"
            />
          </div>
        </div>
        <button
